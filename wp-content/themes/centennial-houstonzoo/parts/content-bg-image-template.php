...
<div class="dynamic-content-container">
    <div class="half-transparent-panel <?php print ($small_size == true) ? 'show-for-medium' : '' ?> <?php print $panel_color; ?>" data-specified-id=<?php print $specified_id; ?>></div>
    <div class="bg-image-content background-cover <?php print ($small_size == true) ? 'small-size show-for-medium' : '' ?>" style="background-image:url(<?php print $image; ?>)" data-specified-id=<?php print $specified_id; ?>>
        <div class="grid-container">
            <div class="grid-x">
                <div class="cell <?php print ($small_size == true) ? 'medium-5' : 'medium-3' ?>">
